...
#define USE_LCD_STR_E 	1			// wysy�a string umieszczony w pami�ci EEPROM
...
#define USE_LCD_DEFCHAR_P 	1		// wysy�a zdefiniowany znak z pami�ci FLASH
#define USE_LCD_DEFCHAR_E 	1		// wysy�a zdefiniowany znak z pami�ci EEPROM
...
void lcd_hex(int val);								// domy�lnie wy��czona z kompilacji w pliku lcd.c
